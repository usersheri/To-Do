...
function ResetPassword() {
  ...
  return (
    <div className="text-center">
      <h1 className="text-2xl font-bold p-5 text-white">Reset Password</h1>
      <form className="w-2/5 mx-auto p-5" onSubmit={handleSubmit}>
        ...
        />
        <button
          className="p-2 rounded-md shadow-md bg-[#2973B2]  text-white px-5 mt-10 disabled:bg-indigo-400"
          disabled={isLoading}
        >
          Reset
        </button>
