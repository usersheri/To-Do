...
function ForgotPassword() {
  ...
  return (
    <div className="text-center">
      <h1 className="text-2xl font-bold p-5 text-white">Forgot Password</h1>
      <form className="w-2/5 mx-auto p-5" onSubmit={handleSubmit}>
        ...
        />
        <button
          className="p-2 rounded-md shadow-md bg-[#2973B2] text-white px-5 mt-10 disabled:bg-indigo-500"
          disabled={isLoading}
        >
          Reset
        </button>
      ...
      {message && (
        <div className="mt-10 bg-green-500 mx-auto w-2/5 p-3 rounded-lg shadow-lg text-white text-lg">
          <p>{message}</p>
        </div>
      )}
      {error && (
